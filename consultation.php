...
function ev_focus_color(string $focus): string {
    return match (true) {
        str_contains(strtolower($focus), 'food') || str_contains(strtolower($focus), 'edible') => 'bg-amber-900/40 text-amber-300 ring-1 ring-amber-700/30',
        str_contains(strtolower($focus), 'look') || str_contains(strtolower($focus), 'curb') => 'bg-sky-900/40 text-sky-300 ring-1 ring-sky-700/30',
